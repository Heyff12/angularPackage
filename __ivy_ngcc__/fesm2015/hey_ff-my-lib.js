...
MyLibComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: MyLibComponent, selectors: [["ml-my-lib"]], decls: 2, vars: 0, template: function MyLibComponent_Template(rf, ctx) { if (rf & 1) {
...
MyTheButtonComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: MyTheButtonComponent, selectors: [["ml-the-button"]], inputs: { text: "text" }, decls: 2, vars: 1, consts: [[1, "theButton"]], template: function MyTheButtonComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, styles: [".theButton[_ngcontent-%COMP%]{border:1px solid pink;border-radius:8px;color:pink;display:inline-block;line-height:32px;min-width:60px;padding:0 6px}"] });
